...
Cette version marque une étape historique pour **T2DECODE**. Après une phase intense de refonte architecturale et de stabilisation, nous passons à un système de déploiement continu (CI/CD) automatisé et multi-plateforme.
