...
class _BandwidthToolScreenState extends State<BandwidthToolScreen> {
  ...
  String _calculateTime() {
    ...
    switch (_speedUnit) {
      ...
      case 'Mbps':
        ...
        break;
      case 'Gbps':
        bps = speed * 1000 * 1000 * 1000;
        break;
      case 'KB/s':
        bps = speed * 8000;
        break;
      case 'MB/s':
        bps = speed * 8 * 1000 * 1000;
        break;
    }
    ...
    switch (_sizeUnit) {
      ...
      case 'MB':
        ...
        break;
      case 'GB':
        bits = size * 8 * 1024 * 1024 * 1024;
        break;
      case 'TB':
        bits = size * 8 * 1024 * 1024 * 1024 * 1024;
        break;
    }
    ...
    return TdcPageWrapper(
      child: ListView(
        children: [
          ...
          _buildInputCard('TAILLE DU FICHIER', _sizeCtrl, _sizeUnit,
              ['KB', 'MB', 'GB', 'TB'], (v) => setState(() => _sizeUnit = v!)),
  ...
  Widget _buildResultCard() {
    return Container(
      ...
      child: Column(
        children: [
          const Text('TEMPS DE TÉLÉCHARGEMENT ESTIMÉ',
              style: TextStyle(
          ...
          const Text('Ajustez les paramètres ci-dessous',
  ...
  Widget _buildInputCard(String label, TextEditingController ctrl, String unit,
      List<String> units, Function(String?) onUnitChanged) {
    return Container(
  ...
  Widget _speedRow(String label, String speed) => Padding(
