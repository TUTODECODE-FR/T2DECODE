...
class _AsciiToolScreenState extends State<AsciiToolScreen> {
  ...
  Widget build(BuildContext context) {
    return TdcPageWrapper(
      child: ListView(
        children: [
          _buildCard('TEXTE (String)', _textCtrl, (s) => _onTextChange(s),
              maxLines: 2),
          const SizedBox(height: 16),
          _buildCard('HEXADÉCIMAL', _hexCtrl, (s) => _onHexChange(s),
              maxLines: 2),
          const SizedBox(height: 16),
          _buildCard('BINAIRE', _binCtrl, (s) => {},
              maxLines: 4, readOnly: true),
          const SizedBox(height: 16),
          _buildCard('DÉCIMAL', _decCtrl, (s) => {},
