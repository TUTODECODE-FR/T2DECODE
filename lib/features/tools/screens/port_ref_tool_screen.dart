...
class _PortRefToolScreenState extends State<PortRefToolScreen> {
  ...
  Widget build(BuildContext context) {
    final filtered = _ports
        .where((p) =>
            p['port']!.contains(_search) ||
            p['service']!.toLowerCase().contains(_search.toLowerCase()) ||
            p['type']!.toLowerCase().contains(_search.toLowerCase()))
        .toList();
        ...
        children: [
          TextField(
            ...
            decoration: const InputDecoration(
                labelText: 'Rechercher port, service ou catégorie',
