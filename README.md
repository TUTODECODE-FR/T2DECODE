...
[![Version](https://img.shields.io/github/v/release/TUTODECODE-OFFICIAL/TUTODECODE-APP?style=for-the-badge&color=indigo&label=STABLE)](https://github.com/TUTODECODE-OFFICIAL/TUTODECODE-APP/releases/latest)
[![Build Status](https://img.shields.io/github/actions/workflow/status/TUTODECODE-OFFICIAL/TUTODECODE-APP/build_release.yml?branch=main&style=for-the-badge&label=BUILD)](https://github.com/TUTODECODE-OFFICIAL/TUTODECODE-APP/actions/workflows/build_release.yml)
[![Licence](https://img.shields.io/github/license/TUTODECODE-OFFICIAL/TUTODECODE-APP?style=for-the-badge&color=blue)](https://github.com/TUTODECODE-OFFICIAL/TUTODECODE-APP/blob/main/LICENSE)
...
### 📥 Téléchargements (v1.0.0 Officielle)

| Plateforme | Binaire | Statut |
| :--- | :--- | :--- |
| ![Android](https://img.shields.io/badge/Android-3DDC84?style=flat-square&logo=android&logoColor=white) | [**Fichier APK**](https://github.com/TUTODECODE-OFFICIAL/TUTODECODE-APP/releases/latest/download/TUTODECODE-Android.apk) | `Stable` |
| ![macOS](https://img.shields.io/badge/macOS-000000?style=flat-square&logo=apple&logoColor=white) | [**Installer PKG**](https://github.com/TUTODECODE-OFFICIAL/TUTODECODE-APP/releases/latest/download/TUTODECODE_Installer_v1.0.0.pkg) | `Signé` |
| ![Windows](https://img.shields.io/badge/Windows-0078D6?style=flat-square&logo=windows&logoColor=white) | [**Installeur EXE**](https://github.com/TUTODECODE-OFFICIAL/TUTODECODE-APP/releases/latest/download/TUTODECODE-Setup.exe) | `Disponible` |
| ![Linux](https://img.shields.io/badge/Linux-FCC624?style=flat-square&logo=linux&logoColor=black) | [**AppImage**](https://github.com/TUTODECODE-OFFICIAL/TUTODECODE-APP/releases/latest) | `FOSS` |
...
2. **Installation** :
   ```bash
   git clone [https://github.com/TUTODECODE-OFFICIAL/TUTODECODE-APP.git](https://github.com/TUTODECODE-OFFICIAL/TUTODECODE-APP.git)
   cd TUTODECODE-APP
   flutter pub get
